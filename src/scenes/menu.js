...
vec3 render(vec2 uv, vec2 fc){
  ...
  float energy = 1. + .6*max(hov, 0.) + warp*3.;
  ...
  float R = pow(smoothstep(.05, .62, warp), 2.)*1.6 + .012 + max(hov, 0.)*.01;
