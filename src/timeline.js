...
export const SHOTS = [
  ...
  { id: 'firehall', name: 'Hall of Giants', start: 8.4, end: 10.4,
    post: P({ bloom: 0.9, zoomBlur: 0.07, trail: 0.35, trailZoom: 0.03, trailRot: 0.01, shake: 0.018, shakeHz: 3, streakTint: [1, 0.6, 0.3], ca: 0.003 }) },
  ...
  { id: 'canyon', name: 'The Fall', start: 14.8, end: 16.0,
    post: P({ bloom: 0.8, zoomBlur: 0.06, trail: 0.22, trailZoom: 0.05, shake: 0.02, shakeHz: 4, ca: 0.005, streakTint: [1, 0.7, 0.4] }) },
  ...
  { id: 'jungle', name: 'Primeval', start: 28.4, end: 30.4,
    post: P({ bloom: 0.8, zoomBlur: 0.05, trail: 0.25, shake: 0.012, shakeHz: 2, sat: 1.05, streakTint: [0.8, 1, 0.6] }) },
